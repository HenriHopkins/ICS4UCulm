...
infoMenu(playerScore,q,op,ans);
    ...
    public static void culmReader(ArrayList<Integer> playerScore, ArrayList<String> q,ArrayList<String> op,ArrayList<String> ans, int n) throws FileNotFoundException, IOException {
        ...
        NbaTrivia timerTest = new NbaTrivia();
      ...
      /* boolean safe = false;
        ...
        */
        ...
        if (players>1) {
           ...
           // System.out.println("Player "+(c+1)+" 's score is: "+playerScore.get(c)); if (timer<2) playGame(c,q,op,ans,playerScore,co,t);}
